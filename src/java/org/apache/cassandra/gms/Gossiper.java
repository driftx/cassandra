...
public class Gossiper implements IFailureDetectionEventListener, GossiperMBean
{
    ...
    public InetAddress getInternalAddress(InetAddress endpoint)
    {
        try
        {
            String internal = getApplicationState(endpoint, ApplicationState.INTERNAL_IP);
            if (internal == null)
                return endpoint;
            return InetAddress.getByName(internal);
        }
        catch (UnknownHostException e)
        {
            throw new RuntimeException(e);
