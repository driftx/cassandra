...
public class HintsMaxSizeTest extends TestBaseImpl
{
    ...
    public void testHintsKeepRecordingAfterNodeGoesOfflineRepeatedly() throws Exception
    {
                                           ...
                                           .start(), 2))
        {
            ...
            // wait 1 minute plus some change to have room for node's status detection
            // for simplicity round it to minute and half
            Thread.sleep(90000);

            // we should not hint anything because the node was down more than 1 minute
